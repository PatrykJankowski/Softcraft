            ...
            <div class="row">
                <div class="col">
                    <div class="offer">
                        ...
                        <div>
                            <h4>Projektowanie</h4>
                            <p>Przygotowaliśmy materiały i koncepcje, a następnie zaczęliśmy realizować projekt. Był on konsultowany z klientem na każdym etapie, aż do momentu wdrożenia materiałów do użytku.</p>
                        </div>
                    </div>
                </div>
            </div>
