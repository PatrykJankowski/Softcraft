...
<?php get_header(); ?>
    ...
    <section class="section section--main--secondary section--project" style="background: url(/wp-content/themes/softcraft/img/muzeum-farmacji-postcard@1920.webp) center; background-size: cover">
    ...
    <section class="section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="header header--center">Muzeum Farmacji jest instytucją kulturalną<br>zwiazaną z Uniwerstetem Medycznym we Wrocławiu</h2>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col">
                    <div class="offer">
                        ...
                        <div>
                            <h4>Projektowanie</h4>
                            <p>Proces projektowy został poprzedzony przygotowaniem materiałów i koncepcji, a następnie projekt był konsultowany z klientem na każdym etapie, aż do momentu wdrożenia materiałów do użytku</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section section--ptn section--pbn">
        <img class="portfolio-img"
             srcset="/wp-content/themes/softcraft/img/muzeum-farmacji-office@1024.webp 1024w,
                     /wp-content/themes/softcraft/img/muzeum-farmacji-office@1920.webp 1920w,
                     /wp-content/themes/softcraft/img/muzeum-farmacji-office@3440.webp 3440w"
             sizes="(max-width: 1024px) 1024w, (max-width: 1920px) 1920w, (max-width: 3440px) 3440w"
             src="/wp-content/themes/softcraft/img/muzeum-farmacji-office@1920.webp"
    ...
    <section class="section">
        <div class="container">
            <div class="row">
                <div class="col">
                    <p>Poniżej widoczne są materiały promocyjne:</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section section--ptn section--pbn">
        <img class="portfolio-img"
             srcset="/wp-content/themes/softcraft/img/muzeum-farmacji-promo@1024.webp 1024w,
                     /wp-content/themes/softcraft/img/muzeum-farmacji-promo@1920.webp 1920w,
                     /wp-content/themes/softcraft/img/muzeum-farmacji-promo@3440.webp 3440w"
             sizes="(max-width: 1024px) 1024w, (max-width: 1920px) 1920w, (max-width: 3440px) 3440w"
             src="/wp-content/themes/softcraft/img/muzeum-farmacji-promo@1920.webp"
        ...
        <div class="container">
            <div class="row">
                <img class="portfolio-img" style="max-height: 100%"
                     src="/wp-content/themes/softcraft/img/muzeum-farmacji-cards.webp"
