...
<?php get_header(); ?>
    ...
    <section class="section section--main--secondary section--project" style="background: url(/wp-content/themes/softcraft/img/4elements@1920.webp) center; background-size: cover">
    ...
    <section class="section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="header header--center">4elements jest działającą w Warszawie szkołą nauki pływania, która organizuje obozy sportowe dla dzieci</h2>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section section--ptn section--pbn">
        <img class="portfolio-img"
             srcset="/wp-content/themes/softcraft/img/4elements-mockup@1024.webp 1024w,
                     /wp-content/themes/softcraft/img/4elements-mockup@1920.webp 1920w,
                     /wp-content/themes/softcraft/img/4elements-mockup@3440.webp 3440w"
             sizes="(max-width: 1024px) 1024w, (max-width: 1920px) 1920w, (max-width: 3440px) 3440w"
             src="/wp-content/themes/softcraft/img/4elements-mockup@1920.webp"
                ...
                <div class="col">
                    <div class="offer">
                        <svg class="offer__icon offer__icon--top" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 33.72 33.72"><g><path d="M28 0H5.71A5.71 5.71 0 000 5.71V28a5.71 5.71 0 005.71 5.71H28A5.71 5.71 0 0033.72 28V5.71A5.71 5.71 0 0028 0zm-.65 12.11c-.69 5.57-2.62 10.11-5.22 12.72h.42a2.4 2.4 0 110 2.55h-11.4a2.36 2.36 0 01-2 1.12 2.4 2.4 0 112-3.67h.42C9 22.22 7.05 17.68 6.36 12.11a2.29 2.29 0 01-1.27-2 2.39 2.39 0 014.78-.24 2.33 2.33 0 01-1 2c.93 7.33 4.25 12.81 7.94 12.81s7-5.47 8-12.8a2.34 2.34 0 01-1-2 2.39 2.39 0 114.78.24 2.33 2.33 0 01-1.23 1.99z" fill="#007FFF"></path></g></svg>                        <div>
                            <h4>Projektowanie</h4>
                            <p>4elements posiada szeroką i różnorodną ofertę, którą staraliśmy się przedstawić za pomocą języka wizualnego – ustaliliśmy schemat kolorystyczny, charakter fotografii oraz spójny szablon</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section section--ptn section--pbn section--bg-tertiary">
        <div class="container">
            <div class="row">
                <img style="margin: 120px 0" src="/wp-content/themes/softcraft/img/4elements-pages.webp">
            </div>
        </div>
    </section>
    ...
    <section class="section section--ptn section--pbn">
        <img class="portfolio-img"
             srcset="/wp-content/themes/softcraft/img/4elements-mobile@1024.webp 1024w,
                     /wp-content/themes/softcraft/img/4elements-mobile@1920.webp 1920w,
                     /wp-content/themes/softcraft/img/4elements-mobile@3440.webp 3440w"
             sizes="(max-width: 1024px) 1024w, (max-width: 1920px) 1920w, (max-width: 3440px) 3440w"
             src="/wp-content/themes/softcraft/img/4elements-mobile@1920.webp"
    ...
    <section class="section section--ptn">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="offer">
                        <svg class="offer__icon offer__icon--top" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 33.72 33.72"><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path fill="#007FFF" d="M28,0H5.71A5.71,5.71,0,0,0,0,5.71V28a5.71,5.71,0,0,0,5.71,5.71H28A5.71,5.71,0,0,0,33.72,28V5.71A5.71,5.71,0,0,0,28,0ZM12,7A2.77,2.77,0,1,1,9.19,9.75,2.76,2.76,0,0,1,12,7Zm1.27,21H9.19a1.28,1.28,0,0,1,0-2.55h4.05a1.28,1.28,0,1,1,0,2.55Zm7.44-5.34H7.92V20.12H20.68Zm5.12-5.36H7.92V14.76H25.8Z"/></g></g></svg>
                        <div>
                            <h4>Rezultat</h4>
                            ...
                            <img src="/wp-content/themes/softcraft/img/4elements-lighthouse.jpg">
                        </div>
                    </div>
                </div>
            </div>
