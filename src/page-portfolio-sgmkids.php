<?php /* Template Name: Portfolio – SGM Kids */ ?>

<?php get_header(); ?>

    <section class="section section--main--secondary section--project" style="background: url(/wp-content/themes/softcraft/img/kids@1920.webp) center; background-size: cover">
    ...
    <section class="section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="header header--center">SGM Kids to mala firma produkująca materiały<br>do zabawy sensorycznej dla dzieci</h2>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col">
                    <div class="offer">
                        ...
                        <div>
                            <h4>Nasze zadanie</h4>
                            <p>Stworzenie identyfikacji wizualnej, zawierającej logo, materiały promocyjne (ulotki, plakaty, roll-up) i materiały biurowe (wizytówki, papier korespondencyjny)</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <img class="portfolio-img" style="max-height: 100%"
                     src="/wp-content/themes/softcraft/img/kids-set2.webp"
                     alt="SGM Kids – materiały biurowe">
            </div>
        </div>
    </section>
    ...
    <section class="section section--ptn section--pbn" style="background-color: #e5e5e5">
        <div class="container">
            <div class="row">
                <img class="portfolio-img"
                     src="/wp-content/themes/softcraft/img/kids-set@1920.webp"
