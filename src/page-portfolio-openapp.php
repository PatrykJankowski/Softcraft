<?php /* Template Name: Portfolio – OpenApp */ ?>

<?php get_header(); ?>

    <section class="section section--main--secondary section--project" style="background: url(/wp-content/themes/softcraft/img/openapp-bg.webp) center; background-size: cover">
    ...
    <section class="section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="header header--center">OpenApp udostępnia rozwiązania dla szybkich płatności w internecie, bez podawania danych</h2>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col">
                    <div class="offer">
                        ...
                        <div>
                            <h4>Nasze zadanie</h4>
                            <p>Wykonanie projektu graficznego oraz stworzenie strony www na podstawie dostarczonej przez klienta identyfikacji wizualnej.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section section--ptn section--pbn">
        <img src="/wp-content/themes/softcraft/img/openapp-mockups.webp" class="portfolio-img portfolio-img--center">
    </section>
                ...
                <div class="col">
                    <div class="offer">
                        <svg class="offer__icon offer__icon--top" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 33.72 33.72"><g><path d="M28 0H5.71A5.71 5.71 0 000 5.71V28a5.71 5.71 0 005.71 5.71H28A5.71 5.71 0 0033.72 28V5.71A5.71 5.71 0 0028 0zm-.65 12.11c-.69 5.57-2.62 10.11-5.22 12.72h.42a2.4 2.4 0 110 2.55h-11.4a2.36 2.36 0 01-2 1.12 2.4 2.4 0 112-3.67h.42C9 22.22 7.05 17.68 6.36 12.11a2.29 2.29 0 01-1.27-2 2.39 2.39 0 014.78-.24 2.33 2.33 0 01-1 2c.93 7.33 4.25 12.81 7.94 12.81s7-5.47 8-12.8a2.34 2.34 0 01-1-2 2.39 2.39 0 114.78.24 2.33 2.33 0 01-1.23 1.99z" fill="#007FFF"></path></g></svg>                        <div>
                            <h4>Projektowanie</h4>
                            <p>Stworzyliśmy projekt graficzny strony www oraz przygotowaliśmy zestaw ikon.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section section--ptn section--pbn">
        <img src="/wp-content/themes/softcraft/img/openapp-bg.webp" class="portfolio-img" alt="OpenApp – strona www">
    </section>
    ...
    <section class="section section--ptn section--pbn">
        <img class="portfolio-img" src="/wp-content/themes/softcraft/img/openapp-mobile.webp">
    </section>
            ...
            <div class="row">
                <div class="col">
                    <div class="offer">
                        ...
                        <div>
                            <h4>Rezultat</h4>
                            <p>Strona dostepna jest pod adresem: <a href="https://open-app.com" target="_blank">open-app.com</a></p>
                            <p>Wynik jaki strona internetowa osiągnęła w narzędziu PageSpeed Insights od Google:</p>
                            <img src="/wp-content/themes/softcraft/img/openapp-pagespeed.webp">
                        </div>
                    </div>
                </div>
            </div>
